...
class AdministrationSteps : En {
    init {
        When("^administrator create the cinema \"([^\"]*)\" in the city \"([^\"]*)\"$")
        ...
        Then(
                "^the cashier mark (\\d+)-th seat at (\\d+)-th row as \"([^\"]*)\"$"
        ...
        And(
                "^(\\d+)-th seat at (\\d+)-th row on show \"([^\"]*)\" is \"([^\"]*)\" yet$"
        ) { arg0: Int, arg1: Int, arg2: String, arg3: String -> }
